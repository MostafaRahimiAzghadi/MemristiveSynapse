...
function lern = pos_pre_pos(param) 
	...
	%plot(f_actP_pos(x,param(1),param(2),param(3),param(4))-f_actP_pre(x+delta_t1(i),param(2),param(1),param(4),param(3)),'g');
	%plot(f_actP_pos(x-(delta_t2(i)-delta_t1(i)),param(1),param(2),param(3),param(4))-f_actP_pre(x+delta_t1(i),param(2),param(1),param(4),param(3)),'g');
